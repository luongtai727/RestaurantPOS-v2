...
class ShiftSpinnerAdapter(
    val activity: Activity,
    val listShiftName: List<String>
    ...
    private fun handleView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val inRowView = context.inflate(R.layout.user_shift_spinner, parent, false)

        // Khai bao bien de lien ket UserRole. Lay resource tu list_monan.XML
        val txtShiftName = inRowView.findViewById<TextView>(R.id.txtShiftName)

        txtShiftName.text = listShiftName[position]
        return inRowView
    }
}